...
class MyEmbedding(nn.Module):
    def __init__(self, num_embeddings=32000, embedding_dim=5120, perceiver_num=32,vis_dim = 768, patch_size=32, frame_patch_size = 4 ,seg_channel = 256, vision_encoder = 'ViT'):
        super().__init__()
        ...
        self.bert_tokenizer = AutoTokenizer.from_pretrained("/mnt/petrelfs/wuchaoyi/RadFM/src/Language_models/MedKEBERT")
        self.bert_model = AutoModel.from_pretrained("/mnt/petrelfs/wuchaoyi/RadFM/src/Language_models/MedKEBERT")
    ...
    def forward(self, text_input, vision_x, key_words_query = None):
        if self.flag == 'Text':
            ...
            # print(f'BLIP forward:  vision_x shape: {vision_x.shape}')
